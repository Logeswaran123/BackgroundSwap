...
# VGG19 architecture taken from below mentioned source.
# Source: https://github.com/gordicaleksa/pytorch-neural-style-transfer/blob/master/models/definitions/vgg_nets.py
class Vgg19(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.slice6(x)
        layer5_1 = x
        vgg_outputs = collections.namedtuple("VggOutputs", self.layer_names)
